...
public final class GntSmallOnboardingDataBinding implements ViewBinding {
  @NonNull
  ...
  private GntSmallOnboardingDataBinding(@NonNull FrameLayout rootView,
      ...
      @NonNull LinearLayout headline, @NonNull ImageView icon,
      @NonNull MaterialCardView iconContainer, @NonNull MediaView mediaView,
  ...
  @NonNull
  public static GntSmallOnboardingDataBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static GntSmallOnboardingDataBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.gnt_small_onboarding_data, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static GntSmallOnboardingDataBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new GntSmallOnboardingDataBinding((FrameLayout) rootView, adNotificationView,
          background, body, content, cta, headline, icon, iconContainer, mediaView, nativeAdView,
